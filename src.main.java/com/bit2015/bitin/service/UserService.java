...
public class UserService {
	 ...
	 * @return userNo userId에 해당하는 userNo return함
	 */
...
////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////////
	...
	/**
	 * @param userVo
	 *            (id, name, password 필수 ) (phoneId 필수아님)
	 * @return 잘 insert되면 true return 실패하면 false return
	 */
	...
	/**
	 * @param userVo
	 * @return 아이디 비번 일치하면 true보냄 불일치 하면 false
	 */
	...
	/**
	 * @param classNo
	 * @return List<String> 으로 List<"userPhoneId"> return 함 classNo의 class안에 있는
	 *         유저들의 phone id return 함
	 */
	 ...
	 * 
	 * @param userId
	 * @return userId가 들어가 있는 수업의 목록 List<String > 형태로
	 */
