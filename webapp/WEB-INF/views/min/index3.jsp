...
<body>
	<c:import url="/WEB-INF/views/include/navi3.jsp"></c:import>
				...
				<div class="card-body card-padding">
					<div id="carousel-example-generic" class="carousel slide" data-ride="carousel" style="margin-top: 16px;">
						...
						<a class="left carousel-control" href="#carousel-example-generic"
							...
							class="zmdi zmdi-chevron-left" aria-hidden="true"></span> <span
						...
						<div class="listview">
							...
							<div class="card go-social">
								...
								<div class="card-body clearfix">
									<a class="col-xs-4" href=""> <img
										src="/bitin/assets/img/social/facebook-128.png" class="img-responsive"
										alt="">
									</a> <a class="col-xs-4" href=""> <img
										src="/bitin/assets/img/social/twitter-128.png" class="img-responsive" alt="">
									</a> <a class="col-xs-4" href=""> <img
										src="/bitin/assets/img/social/googleplus-128.png" class="img-responsive"
										alt="">
									</a> <a class="col-xs-4" href=""> <img
										src="/bitin/assets/img/social/linkedin-128.png" class="img-responsive"
										alt="">
									</a> <a class="col-xs-4" href=""> <img
										src="/bitin/assets/img/social/youtube-128.png" class="img-responsive" alt="">
									</a> <a class="col-xs-4" href=""> <img
										src="/bitin/assets/img/social/blogger-128.png" class="img-responsive" alt="">
									</a>
								</div>
							</div>
	...
	<script
		src="/bitin/assets/vendors/bower_components/mediaelement/build/mediaelement-and-player.min.js"></script>
