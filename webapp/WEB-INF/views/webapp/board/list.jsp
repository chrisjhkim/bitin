...
<%-- 				<button class="btn btn-warning btn-block" onclick="location.href='/bitin/webapp/board/write-form?userNo=${fakeAuthUser.userNo}&boardNo=${list[0].boardNo }'" --%>
				<button class="btn btn-warning btn-block" onclick="location.href='/bitin/webapp/board/write-form?userNo=${fakeAuthUser.userNo}&boardNo=${boardNo }'"
	...
	$("#data-table-basic").bootgrid(
			{
				...
				formatters : {
					"link" : function(column, row) {
						return "<a href=\"/bitin/webapp/board/view-post?userNo=${fakeAuthUser.userNo}&postNo="+row.no+"\">"
								+ row.title + "</a>";
					}
				}
			});
