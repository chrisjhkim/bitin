				...
				<table id="data-table-basic" class="table table-striped" data-link="row">
					<thead>
						<tr id="table-abc">
							...
							<c:if test="${attdDataMap.attdCounter>0}"><th data-column-id="fixed1" data-formatter="newtest1">${attdDataMap.dataList[0].attdList[0].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>1}"><th data-column-id="fixed2" data-formatter="newtest2">${attdDataMap.dataList[0].attdList[1].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>2}"><th data-column-id="fixed3" data-formatter="newtest3">${attdDataMap.dataList[0].attdList[2].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>3}"><th data-column-id="fixed4" data-formatter="newtest4">${attdDataMap.dataList[0].attdList[3].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>4}"><th data-column-id="fixed5" data-formatter="newtest5">${attdDataMap.dataList[0].attdList[4].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>5}"><th data-column-id="fixed6" data-formatter="newtest6">${attdDataMap.dataList[0].attdList[5].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>6}"><th data-column-id="fixed7" data-formatter="newtest7">${attdDataMap.dataList[0].attdList[6].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>7}"><th data-column-id="fixed8" data-formatter="newtest8">${attdDataMap.dataList[0].attdList[7].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>8}"><th data-column-id="fixed9" data-formatter="newtest9">${attdDataMap.dataList[0].attdList[8].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>9}"><th data-column-id="fixed10" data-formatter="newtest10">${attdDataMap.dataList[0].attdList[9].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>10}"><th data-column-id="fixed11" data-formatter="newtest11">${attdDataMap.dataList[0].attdList[10].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>11}"><th data-column-id="fixed12" data-formatter="newtest12">${attdDataMap.dataList[0].attdList[11].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>12}"><th data-column-id="fixed13" data-formatter="newtest13">${attdDataMap.dataList[0].attdList[12].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>13}"><th data-column-id="fixed14" data-formatter="newtest14">${attdDataMap.dataList[0].attdList[13].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>14}"><th data-column-id="fixed15" data-formatter="newtest15">${attdDataMap.dataList[0].attdList[14].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>15}"><th data-column-id="fixed16" data-formatter="newtest16">${attdDataMap.dataList[0].attdList[15].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>16}"><th data-column-id="fixed17" data-formatter="newtest17">${attdDataMap.dataList[0].attdList[16].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>17}"><th data-column-id="fixed18" data-formatter="newtest18">${attdDataMap.dataList[0].attdList[17].classDate }</th></c:if>
							<c:if test="${attdDataMap.attdCounter>18}"><th data-column-id="fixed19" data-formatter="newtest19">${attdDataMap.dataList[0].attdList[18].classDate }</th></c:if>
						</tr>
					</thead>
					<tbody>
						<c:forEach items='${attdDataMap.dataList }' var='vo' varStatus='status'>
							<tr>
									<td>${vo.userName}</td>
 									<td>${vo.userNo}</td>
									<td>${vo.attdRate }</td>
...
<%-- 									<td>${vo.attdList[0].attdStatus }</td> --%>
									<c:if test="${attdDataMap.attdCounter>0 }"><td>${vo.attdList[0].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>1 }"><td>${vo.attdList[1].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>2 }"><td>${vo.attdList[2].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>3 }"><td>${vo.attdList[3].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>4 }"><td>${vo.attdList[4].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>5 }"><td>${vo.attdList[5].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>6 }"><td>${vo.attdList[6].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>7 }"><td>${vo.attdList[7].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>8 }"><td>${vo.attdList[8].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>9 }"><td>${vo.attdList[9].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>10 }"><td>${vo.attdList[10].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>11 }"><td>${vo.attdList[11].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>12 }"><td>${vo.attdList[12].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>13 }"><td>${vo.attdList[13].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>14 }"><td>${vo.attdList[14].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>15 }"><td>${vo.attdList[15].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>16 }"><td>${vo.attdList[16].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>17 }"><td>${vo.attdList[17].attdStatus }</td></c:if>
									<c:if test="${attdDataMap.attdCounter>18 }"><td>${vo.attdList[18].attdStatus }</td></c:if>
...
// 		startDateHTML.innerHTML = "${attdDataMap.startDate}";
		...
		var parsedEndDate = endDate.substring(0,4)+"년"
							+endDate.substring(5,7)+"월"
							+endDate.substring(8,10)+"일 까지";
...
function modifyDateRange() {
	...
	if( dateRangeStart > dateRangeEnd) {
		...
		targetUrl = "/bitin/webapp/attd?userId=${fakeAuthUser.userId}&classNo=${classNo}&from="+dateRangeStart+"&to="+dateRangeEnd;
...
function modalModify() {
	...
	var firstAttdNo = "${attdDataMap.dataList[0].attdList[0].attdNo}"
	$.ajax({
