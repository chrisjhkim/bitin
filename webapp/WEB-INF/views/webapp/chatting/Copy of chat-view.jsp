				...
				<div class="lv-header-alt clearfix">
					<div class="lvh-label hidden-sm">
						<div class="lv-avatar pull-left">
							<img src="/bitin/assets/img/profile-pics/${toUserNo }.jpg" alt="">
						</div>
						<span class="c-black">${userName }님과 대화</span>
					</div>
					...
					<ul class="lv-actions actions">
						<li class="dropdown">
							...
							<ul class="dropdown-menu dropdown-menu-right">
								<li><a href="">새로고침</a></li>
								<li><a href="/bitin/index">채팅 나가기</a></li>
							</ul>
						</li>
					</ul>
				</div>
...
<script>
		...
		$(document).ready(
						function() {
							timer = setInterval(
									function() {
										$.ajax({
													url : "/bitin//webapp-api/apilist?chrisTempUserNo="+myNo+"&toUserNo="+toUserNo,
													cache : false,
													type : "post",
													success : function(
															response) {
	...
	var insertMessage = function(data, isHead) {
		...
		if (authUser == data.fromUserNo) {
			temp2 = "<div id='chatlist'  class='lv-body'>"
					+ "<div class='lv-item media right'>"
					+ "<div class='lv-avatar pull-right'>"
					+ "<img src='/bitin/assets/img/profile-pics/${authUser.userNo}.jpg' alt=''></div>"
					+ "<div class='media-body'><div class='ms-item'>"
					+ data.message
					+ "</div>"
		...
		$listDiv.append(temp2);
				...
				<div class="lv-body">
					<div style="overflow: scroll; height: 330px; padding: 1px;">
